...
#undef MEMORY_POOL_START
#define MEMORY_POOL_START ((uintptr_t)x360_game_heap)
#undef MEMORY_POOL_END
#define MEMORY_POOL_END ((uintptr_t)(x360_game_heap+sizeof(x360_game_heap)))
#undef SEG_RACING
#define SEG_RACING MEMORY_POOL_END
#undef SEG_ENDING
#define SEG_ENDING MEMORY_POOL_END
#undef SEG_START
#define SEG_START ((uintptr_t)(x360_rom+0xC00))
#undef SEG_DATA_START
#define SEG_DATA_START ((uintptr_t)(x360_rom+0x12AAE0))
#undef SEG_DATA_END
#define SEG_DATA_END ((uintptr_t)(x360_rom+0x132B50))
#undef COMMON_TEXTURES_ROM_START
#define COMMON_TEXTURES_ROM_START ((uintptr_t)(x360_rom+0x132B50))
#undef COMMON_TEXTURES_SIZE
#define COMMON_TEXTURES_SIZE 0x12920
#undef CEREMONY_DATA_ROM_START
#define CEREMONY_DATA_ROM_START (x360_rom+0x821D10)
#undef CEREMONY_DATA_ROM_END
#define CEREMONY_DATA_ROM_END (x360_rom+0x825800)
#undef STARTUP_LOGO_ROM_START
#define STARTUP_LOGO_ROM_START (x360_rom+0x825800)
#undef STARTUP_LOGO_ROM_END
#define STARTUP_LOGO_ROM_END (x360_rom+0x8284D0)
#endif
