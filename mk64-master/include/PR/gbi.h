...
/* MK64_X360_V14_LANGUAGE_FIX
 * Old Xbox 360 XDK MSVC translation units sometimes include PR/gbi.h
 * directly instead of entering through ultra64.h/mbi.h.  In that path
 * the original SDK language macro is absent, hiding Vtx/Mtx/Gfx typedefs.
 */
