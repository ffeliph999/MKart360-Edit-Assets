...
#define X360_AUDIO_ROM(original,offset) (x360_rom+(offset))
#else
#define X360_AUDIO_ROM(original,offset) (original)
#endif
#include <ultra64.h>
#include <macros.h>
...
void audio_init(void) {
    ...
    s32 j, k;
    s32 ctlSeqCount;
    /* Header DMA reads 16 bytes, including the first table entry. */
    u32 buf[4];
    ...
    data = X360_AUDIO_ROM(&_sequencesSegmentRomStart,0xBC5F60);
    ...
    data = X360_AUDIO_ROM(&_audio_banksSegmentRomStart,0x966260);
    ...
    data = X360_AUDIO_ROM(&_audio_tablesSegmentRomStart,0x979AA0);
    ...
    audio_dma_copy_immediate((u8 *) X360_AUDIO_ROM(&_instrument_setsSegmentRomStart,0xBE90E0), gAlBankSets, 0x100);
