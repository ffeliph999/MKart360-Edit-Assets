...
void init_red_shell_texture(void) {
    ...
    s16* green_shell_texture = (s16*) segmented_to_virtual((const void*) common_tlut_green_shell);
...
void render_cows(Camera* camera, Mat4 arg1, UNUSED struct Actor* actor) {
    ...
    var_t1 = (struct ActorSpawnData*) segmented_to_virtual((const void*) d_course_moo_moo_farm_cow_spawn);
    D_8015F704 = 6.4e7f;
...
void evaluate_collision_player_palm_trees(Player* player) {
    ...
    struct UnkActorSpawnData* data = (struct UnkActorSpawnData*) segmented_to_virtual((const void*) d_course_dks_jungle_parkway_tree_spawn);
...
void func_80298D10(void) {
    ...
    struct UnkActorSpawnData* temp_v1 =
        (struct UnkActorSpawnData*) segmented_to_virtual((const void*) d_course_dks_jungle_parkway_tree_spawn);
...
void spawn_piranha_plants(struct ActorSpawnData* spawnData) {
    ...
    struct ActorSpawnData* temp_s0 = (struct ActorSpawnData*) segmented_to_virtual((const void*) spawnData);
...
void spawn_foliage(struct ActorSpawnData* arg0) {
    ...
    var_s3 = (struct ActorSpawnData*) segmented_to_virtual((const void*) arg0);
...
UNUSED void prototype_actor_spawn_data(Player* player, uintptr_t arg1) {
    ...
    var_s0 = (struct test*) segmented_to_virtual((const void*) arg1);
