...
#ifdef XBOX360_PORT
    TrackSections* section = (TrackSections*) x360_resolve_address(addr, gSegmentTable);
#else
...
void render_course_segments(uintptr_t addr, struct UnkStruct_800DC5EC* arg1) {
    ...
    //! @todo Should be Gfx*
#ifdef XBOX360_PORT
    s32* gfx = (s32*) x360_resolve_address(addr, gSegmentTable);
#else
...
void render_choco_mountain(struct UnkStruct_800DC5EC* arg0) {
    ...
    gDPSetCombineLERP(gDisplayListHead++, TEXEL0, 0, SHADE, 0, 0, 0, 0, SHADE, 0, 0, 0, COMBINED, 0, 0, 0, COMBINED);
    ...
    gDPSetCombineLERP(gDisplayListHead++, 0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0, 0, 0, 0, COMBINED, 0, 0, 0, COMBINED);
...
void render_yoshi_valley(struct UnkStruct_800DC5EC* arg0) {
    ...
    gDPPipeSync(gDisplayListHead++);
    gDPSetCombineLERP(gDisplayListHead++, TEXEL0, 0, SHADE, 0, 0, 0, 0, SHADE, TEXEL0, 0, SHADE, 0, 0, 0, 0, SHADE);
    gDPSetRenderMode(gDisplayListHead++, G_RM_AA_ZB_OPA_SURF, G_RM_AA_ZB_OPA_SURF2);
    gSPClearGeometryMode(gDisplayListHead++, G_LIGHTING);
