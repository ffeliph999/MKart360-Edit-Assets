#ifdef XBOX360_PORT
#define X360_BANK_ADDRESS(sym,offset,address) ((u8*)x360_asset_dma_address((uintptr_t)(x360_rom+(offset)),(uintptr_t)(address)))
#else
#define X360_BANK_ADDRESS(sym,offset,address) (&(sym)[SEGMENT_OFFSET(address)])
#endif
#ifdef XBOX360_PORT
...
#ifdef XBOX360_PORT
    return x360_resolve_address((uintptr_t)addr,gSegmentTable);
#else
...
UNUSED uintptr_t func_802A8348(s32 arg0, s32 arg1, s32 arg2) {
    ...
    osPiStartDma(&gDmaIoMesg, 0, 0, (uintptr_t) X360_BANK_ADDRESS(_other_texturesSegmentRomStart, 0x641F70, (arg0)), newAddr, offset,
                 &gDmaMesgQueue);
...
UNUSED u8* func_802A841C(u8* arg0, s32 arg1, s32 arg2) {
    ...
    osPiStartDma(&gDmaIoMesg, 0, 0, (uintptr_t) X360_BANK_ADDRESS(_other_texturesSegmentRomStart, 0x641F70, (arg0)), temp_a0, arg1,
                 &gDmaMesgQueue);
    osRecvMesg(&gDmaMesgQueue, &gMainReceivedMesg, 1);
...
u8* dma_textures(u8 texture[], size_t arg1, size_t arg2) {
    ...
    osPiStartDma(&gDmaIoMesg, 0, 0, (uintptr_t) X360_BANK_ADDRESS(_other_texturesSegmentRomStart, 0x641F70, (texture)),
...
uintptr_t MIO0_0F(u8* arg0, uintptr_t arg1, uintptr_t arg2) {
    ...
    osPiStartDma(&gDmaIoMesg, 0, 0, (uintptr_t) X360_BANK_ADDRESS(_other_texturesSegmentRomStart, 0x641F70, (arg0)), temp_v0, arg1,
                 &gDmaMesgQueue);
    osRecvMesg(&gDmaMesgQueue, &gMainReceivedMesg, 1);
...
void decompress_vtx(CourseVtx* arg0, u32 vertexCount) {
    ...
    void* freeSpace;
    u8* vtxCompressed = segmented_to_virtual((const void*) arg0);
    UNUSED s32 pad;
...
void unpack_combine_mode1(Gfx* arg0, UNUSED u8* arg1, UNUSED uintptr_t arg2) {
    Gfx macro[] = { gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, TEXEL0, 0, SHADE, 0, TEXEL0, 0, SHADE, 0, TEXEL0, 0, SHADE, 0) };
    arg0[sGfxSeekPosition].words.w0 = macro->words.w0;
    arg0[sGfxSeekPosition].words.w1 = macro->words.w1;
    sGfxSeekPosition++;
}
...
void unpack_combine_mode2(Gfx* arg0, UNUSED u8* arg1, UNUSED uintptr_t arg2) {
    Gfx macro[] = { gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0) };
    arg0[sGfxSeekPosition].words.w0 = macro->words.w0;
    arg0[sGfxSeekPosition].words.w1 = macro->words.w1;
    sGfxSeekPosition++;
}
...
void unpack_combine_mode_shade(Gfx* arg0, UNUSED u8* arg1, UNUSED uintptr_t arg2) {
    Gfx macro[] = { gsDPSetCombineLERP(0, 0, 0, SHADE, 0, 0, 0, SHADE, 0, 0, 0, SHADE, 0, 0, 0, SHADE) };
    arg0[sGfxSeekPosition].words.w0 = macro->words.w0;
    arg0[sGfxSeekPosition].words.w1 = macro->words.w1;
    sGfxSeekPosition++;
}
...
void unpack_combine_mode5(Gfx* arg0, UNUSED u8* arg1, UNUSED uintptr_t arg2) {
    Gfx macro[] = { gsDPSetCombineLERP(0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0) };
    arg0[sGfxSeekPosition].words.w0 = macro->words.w0;
    arg0[sGfxSeekPosition].words.w1 = macro->words.w1;
    sGfxSeekPosition++;
}
...
void displaylist_unpack(uintptr_t* data, uintptr_t finalDisplaylistOffset, u32 arg2) {
    ...
    u8* packed_dl = segmented_to_virtual((const void*) data);
...
void decompress_textures(u32* arg0) {
    u32 segment = SEGMENT_NUMBER2(arg0);
    u32 offset = SEGMENT_OFFSET(arg0);
    struct UnkStr_802AA7C8* phi_s0 = (struct UnkStr_802AA7C8*) segmented_to_virtual((const void*) arg0);
