...
#define X360_REMAINING_BANK_ADDRESS(address) ((u8*)x360_asset_dma_address((uintptr_t)(x360_rom+0x145470),(uintptr_t)(address)))
#else
#define X360_REMAINING_BANK_ADDRESS(address) &_kart_texturesSegmentRomStart[SEGMENT_OFFSET(address)]
#endif
/*
 * @file Replays
...
extern s32 mio0encode(void* input, s32, void*);
extern s32 func_80040174(void*, s32, void*);
...
void load_course_ghost(void) {
    ...
    osPiStartDma(&gDmaIoMesg, 0, 0, (uintptr_t) X360_REMAINING_BANK_ADDRESS(D_80162DC4),
...
s32 func_800051C4(void) {
    ...
    if (sReplayGhostBufferSize != 0) {
        ...
        func_80040174((void*) sReplayGhostBuffer, (sReplayGhostBufferSize * 4) + 0x20, (void*) sReplayGhostEncoded);
        phi_v0 =
            mio0encode((void*) sReplayGhostEncoded, (sReplayGhostBufferSize * 4) + 0x20, (void*) gReplayGhostCompressed);
        return phi_v0 + 0x1e;
    }
}
