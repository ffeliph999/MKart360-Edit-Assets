...
Gfx* func_80095BD0(Gfx* displayListHead, u8* arg1, f32 arg2, f32 arg3, u32 arg4, u32 arg5, f32 arg6, f32 arg7) {
    ...
    if (gMatrixEffectCount < 0 || gMatrixEffectCount >= MTX_EFFECT_POOL_SIZE) {
...
func_80095BD0_label1:
    rmonPrintf("Effect matrix pool exhausted\n");
    return displayListHead;
...
#ifdef XBOX360_PORT
#define D_0B002A00 ((u8*)segmented_to_virtual((void*)0x0B002A00))
#else
...
Gfx* func_80096CD8(Gfx* displayListHead, s32 xPos, s32 yPos, u32 width, u32 height) {
    ...
    gDPSetCombineLERP(displayListHead++, TEXEL0, 0, PRIMITIVE, 0, TEXEL0, 0, PRIMITIVE, 0, TEXEL0, 0, PRIMITIVE, 0, TEXEL0, 0, PRIMITIVE, 0);
...
void dma_copy_mio0_segment(u64* data, size_t nbytes, void* vaddr) {
    ...
    osPiStartDma(&mb, OS_MESG_PRI_NORMAL, OS_READ, (uintptr_t) X360_BANK_ADDRESS(_textures_0aSegmentRomStart, 0x729A30, (data)),
...
void dma_tkmk00_textures(u64* data, size_t nbytes, void* vaddr) {
    ...
    osInvalDCache(vaddr, nbytes);
    osPiStartDma(&mb, OS_MESG_PRI_NORMAL, OS_READ, (uintptr_t) X360_BANK_ADDRESS(_textures_0bSegmentRomStart, 0x7FA3C0, (data)),
                 vaddr, nbytes, &gDmaMesgQueue);
    osRecvMesg(&gDmaMesgQueue, &msg, OS_MESG_BLOCK);
}
...
void func_80099AEC(void) {
    ...
    osPiStartDma(&mb, 0, 0, (uintptr_t) X360_BANK_ADDRESS(_textures_0aSegmentRomStart, 0x729A30, (texPtr->textureData)),
...
void func_80099EC4(void) {
    ...
    osPiStartDma(&sp68, 0, 0, (uintptr_t) X360_BANK_ADDRESS(_textures_0aSegmentRomStart, 0x729A30, (temp_s2->textureData)),
...
void func_8009DB8C(void) {
    ...
    gDPSetCombineLERP(gDisplayListHead++, 0, 0, 0, PRIMITIVE, 0, 0, 0, PRIMITIVE, 0, 0, 0, PRIMITIVE, 0, 0, 0, PRIMITIVE);
    for (var_s0 = 0; var_s0 < 0x4B0; var_s0++) {
        if (sTKMK00_LowResBuffer[var_s0] != 0) {
            temp_t4 = (var_s0 % 40) * 8;
            temp_t5 = (var_s0 / 40) * 8;
