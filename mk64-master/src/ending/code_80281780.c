#ifdef XBOX360_PORT
#define X360_COURSE_ROM(original,offset) (x360_rom+(offset))
#else
#define X360_COURSE_ROM(original,offset) (original)
#endif
#ifdef XBOX360_PORT
...
void load_ceremony_cutscene(void) {
    ...
    set_segment_base_addr(6, (void*) decompress_segments((u8*) X360_COURSE_ROM(&_course_banshee_boardwalk_dl_mio0SegmentRomStart, 0x831DC0),
                                                         (u8*) X360_COURSE_ROM(&_course_yoshi_valley_dl_mio0SegmentRomStart, 0x835BA0)));
    D_8015F8E4 = -2000.0f;
